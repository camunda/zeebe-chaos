...
max-throughput.png) added from Grafana. data-flow.svg is generated by gen_dataflow.py; the bar charts
by ~/config/dotfiles/scripts/chaos-charts/example_optimize_variable_filtering.py.
-->
